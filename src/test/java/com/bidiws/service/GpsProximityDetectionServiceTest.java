 ...
 *
 * Le filtre "tournee encore PLANIFIEE/EN_COURS" est pose directement dans
 * ArretRepository.findByTourneeIdAndStatut (requete JPQL), pas ici : un
 * arret sur une tournee TERMINEE/ANNULEE n'est donc jamais retourne par le
 * mock du repository, jamais traite — rien a tester cote service pour ce
 * cas, cf. ArretRepositoryTest / verification manuelle de la requete.
 */
